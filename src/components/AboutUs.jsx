export default function AboutUs() {
  return (
    <div className="my-16 lg:mx-24 mx-8 text-start">
      <h1 className="text-4xl font-bold  pb-4">Our History</h1>
      <p className="pb-8">
        ...
        portals. Our invincible experience and rich experience has raised our
        spirit to reach school from our client's expectation. Commendable
